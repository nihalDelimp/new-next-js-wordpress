               ...
               <div className="row">
                  {resData && resData.length > 0 &&
                     resData.map((item, index) =>
                        <div key={index + 1} className="col-lg-4 col-sm-12 pt-4 pb-4 text-center">
                           <div className="our-team-container">
                              <div className="our-team-image">
                                 {item.profileImage && item.profileImage.sourceUrl ?
                                    <img src={item.profileImage.sourceUrl} width="200" height="200" />
                                    :
                              ...
                              <div className="our-team-content text-center mt-4 mb-4">
                                 <p className="big text-primary mb-1">{item?.candidateName}</p>
                                 <h4 className="text-dark-grey mt-1 mb-1">{item?.about}</h4>
                                 <p className="big pb-2 text-primary">{item?.department}</p>
                              </div>
                           </div>
                        </div>)}
